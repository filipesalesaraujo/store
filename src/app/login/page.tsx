        ...
        <CardContent>
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-2.5">
              ...
              <Input type="text" id="username" placeholder="" className=" border-gray-300 rounded-xl text-black transition-colors focus:border-blue-300" value={username} onChange={(e) => setUsername(e.target.value)} />
            </div>
            <div className="flex flex-col gap-2.5">
              <Label htmlFor="password" className="text-black">Password</Label>
              <Input type="password" id="password" placeholder="" className=" border-gray-300 rounded-xl text-black transition-colors focus:border-blue-300" value={password} onChange={(e) => setPassword(e.target.value)} />
            </div>
